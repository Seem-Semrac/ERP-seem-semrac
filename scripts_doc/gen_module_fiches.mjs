...
const M = [
  ...
  { svc:'production', label:'Production', route:'/production/service', file:'src/prod.tsx', rw:'production', r:'be, achats, oas, qualité, sécurité, expéditions, stock, maintenance',
    ...
    api:['production','bdt','bds','planning','process','machine(s)','presence','sortie-matiere'], tables:['commandes','lots','bons_de_travail','bons_sous_traitance','machines','postes','shifts','absences','operateur_presence','affectation_poste','process_atelier'],
