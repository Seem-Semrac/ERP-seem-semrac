...
3. Saisir la **réalisation** de chaque morceau (pré-remplie à la moitié) ; le morceau 1 peut ne porter que le réglage. **« + Ajouter un morceau »** (12 au maximum), corbeille (2 au minimum).
4. **« Découper »** : le BDT d'origine devient le morceau 1 (réglage compris) et garde son numéro ; les suivants **-M2**, **-M3**… ont un réglage 0. Tous restent dans la goulotte. Fenêtre ouverte sur un BDT modifié entre-temps → « Page périmée ».
