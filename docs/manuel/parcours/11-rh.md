...
> ℹ️ Sans pointage, la Gestion des Temps reconstitue les heures depuis la **présence** saisie en Production, avec les horaires de la **cadence usine** du site de l'opérateur ce jour-là (ex. cadence Moyen : Matin 05:30-13:15 = 7,25 h). « Validé par » indique la cadence utilisée. Ces horaires ne se corrigent pas ici : c'est la présence (Production) ou la cadence (Production › Process Ateliers › Cadence usine) qu'il faut corriger.
