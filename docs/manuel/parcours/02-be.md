...
> ⚠ capture à rafraîchir (lot H0, 17/09/2026) : cases prix et boutons de demande de prix des compartiments Matière / Accessoires modifiés.
...
- **Matière (tôle)** — la référence de tôle : si un prix de moins de 6 mois existe, il s'affiche seul ; un prix plus ancien reste affiché **en orange** (jamais remis à 0), et sans prix un bouton « demande de prix » apparaît. Le bouton de demande de prix est disponible **à tout moment** sur chaque ligne, même avec un prix récent. Le champ « Pc/tôle » répartit le prix par pièce.
- **Accessoires** — les fournitures achetées (visserie, joints…) : fournisseur, référence, prix paquet (mêmes règles de prix), quantité par paquet et nombre par pièce.
