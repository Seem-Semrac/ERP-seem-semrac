...
5. **Conforme** (toutes les lignes à « Oui » — un reliquat n'est pas un écart : un PV Conforme peut porter une ligne « Reliquat annoncé », règle confirmée le 16/09/2026) : valider. Les quantités reçues partent dans **Stock › Rangement / Mise en stock** ; un reliquat crée un **BC de reliquat** aux Achats (date à valider).
