...
- **Fabriquer un assemblage** : nomenclature **mère** dont les composants (standards ou mères, 5 niveaux au plus) sont rangés dans l'**ordre de fabrication**, du haut vers le bas → à la commande, le lot de la mère reçoit **un sous-lot par composant** (et des sous-sous-lots pour une sous-mère), chacun avec sa gamme, sa prépa et ses achats → programmés dès que la matière est en stock, assemblage signalé « sous-lots en cours » → libération et livraison du **lot de la mère** quand tout l'arbre est fini.
